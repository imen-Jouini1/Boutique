...
if ($_POST) {
    ...
    if (empty($error)) {
        ...
        if ($resultat->execute()) {
            ...
            $_SESSION['success'] = '<div class="alert alert-success">Félicitations le produit sa été ajouté avec succèss</div>';
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <option selected value="m">Conserve</option>
                    <option <?= ($public == 'f') ? 'selected' : '' ?> value="f">Episserie</option>
                    <option <?= ($public == 'public') ? 'selected' : '' ?> value="mixte">Confiserie</option>
                    </select>
                </div>
                <div class="form-group">
                    <label>Photo :</label>
