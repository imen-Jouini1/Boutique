...
if (empty($_SESSION['panier']['id_produit'])) {
    ...
    for ($i = 0; $i < count($_SESSION['panier']['id_produit']); $i++) {
        ...
        echo '<td>' . $_SESSION['panier']['prix'][$i] . ' DT</td>';
        echo '<td>' . $_SESSION['panier']['prix'][$i] * $_SESSION['panier']['quantite'][$i] . ' DT</td>';
    ...
    echo "<tr><th colspan='4'>Total</th><td colspan='2'>" . montantTotal() . " DT</td></tr>";
    if (userConnecte()) {
