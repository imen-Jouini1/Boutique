...
<div class="alert alert-info text-center"><h2>Fiche du produit <?= $titre ?></h2></div>
<?= $html ?>
    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel-default border">
            ...
            <div class="panel-body">
                ...
                <p class="text-center">Prix : <?= number_format($prix, 2, ',', ' ') ?> DT</p>
                <hr>
        ...
        <?php foreach ($suggestions as $sug) : ?>
            ...
            <div class="col-xs-6 col-lg-4" style="margin-top: 10px;">
                <div class="panel-default border">
                    ...
                    <p class="text-center"><?= number_format($prix, 2, ',', ' ') ?>DT</p>
