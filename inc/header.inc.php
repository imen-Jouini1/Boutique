...
<nav class="navbar navbar-inverse ma-nav">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?= RACINE_SITE ?>boutique.php">ElMouna</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li <?= ($page == 'Boutique') ? 'class="active"' : '' ?> ><a href="<?= RACINE_SITE ?>boutique.php">Accueil</a>
                </li>
                ...
                <?php if (userAdmin()) : ?>
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Admin <span
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?= RACINE_SITE ?>admin/gestion_membres.php">Gestion des Clients</a></li>
                            <li><a href="<?= RACINE_SITE ?>admin/gestion_commandes.php">validation des commandes</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
